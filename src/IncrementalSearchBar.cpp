    ...
    _searchTimer(nullptr)
{
    ...
    connect(_searchTimer, &QTimer::timeout, this,
            &terminal::IncrementalSearchBar::notifySearchChanged);
    ...
    connect(_findNextButton, &QToolButton::clicked, this,
            &terminal::IncrementalSearchBar::findNextClicked);
    ...
    connect(_findPreviousButton, &QToolButton::clicked, this,
            &terminal::IncrementalSearchBar::findPreviousClicked);
    ...
    connect(_searchFromButton, &QToolButton::clicked, this,
            &terminal::IncrementalSearchBar::searchFromClicked);
    ...
    connect(closeButton, &QToolButton::clicked, this, &terminal::IncrementalSearchBar::closeClicked);
    ...
    connect(_caseSensitive, &QAction::toggled, this,
            &terminal::IncrementalSearchBar::matchCaseToggled);
    ...
    connect(_regExpression, &QAction::toggled, this,
            &terminal::IncrementalSearchBar::matchRegExpToggled);
    ...
    connect(_highlightMatches, &QAction::toggled, this,
            &terminal::IncrementalSearchBar::highlightMatchesToggled);
    ...
    connect(_reverseSearch, &QAction::toggled, this,
            &terminal::IncrementalSearchBar::updateButtonsAccordingToReverseSearchSetting);
