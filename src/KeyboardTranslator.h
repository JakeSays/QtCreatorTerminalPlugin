 ...
 *
 * terminal supports multiple keyboard translators, allowing the user to
...
public:
    ...
    public:
         ...
         *
         * TODO: The numbers used to replace '*' characters are taken from the terminal/KDE 3 code.
         * Document them.
         *
