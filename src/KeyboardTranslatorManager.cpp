...
void KeyboardTranslatorManager::addTranslator(KeyboardTranslator *translator)
{
    ...
    if (!saveTranslator(translator)) {
        qCDebug(TerminalDebug) << "Unable to save translator" << translator->name()
                              << "to disk.";
    }
}
...
bool KeyboardTranslatorManager::deleteTranslator(const QString &name)
{
    ...
    if (QFile::remove(path)) {
        ...
        qCDebug(TerminalDebug) << "Failed to remove translator - " << path;
        return false;
    }
}
...
const KeyboardTranslator *KeyboardTranslatorManager::findTranslator(const QString &name)
{
    ...
    if (translator != nullptr) {
        ...
        qCDebug(TerminalDebug) << "Unable to load translator" << name;
    }
...
bool KeyboardTranslatorManager::saveTranslator(const KeyboardTranslator *translator)
{
    ...
    if (!destination.open(QIODevice::WriteOnly | QIODevice::Text)) {
        qCDebug(TerminalDebug) << "Unable to save keyboard translation:"
