...
public:
    ...
    explicit TerminalDisplay(Session *session, QWidget *parent = nullptr);
...
public Q_SLOTS:
     ...
     *
     * When set to true, terminal will send Mouse Tracking events.
     *
...
Q_SIGNALS:
     ...
     */
    void configureRequest(const QPoint &position, SpotType spotType);
